...
<body>
    <div style="width: 100%; max-width: 1260px; margin: auto">
        <table width="100%">
            <tr style="border-bottom: 1px solid #000000; width:800px">
                <td style="text-align: center; align:center"><h5>Отчёт преподавателя кафедры (название) (ФИО) о выполнении индивидуального плана 
                за первое полугодие (год) учебный год</h5></td></tr>
            <tr style="border-bottom: 1px solid #000000">
                <td style="text-align: left"><h5>ФИО: </h5></td></tr>
            <tr style="border-bottom: 1px solid #000000">
                <td style="text-align: left"><h5>Должность: </h5></td></tr>
            <tr style="border-bottom: 1px solid #000000">
                <td style="text-align: left"><h5>Степень, звание: </h5></td></tr>
            <tr style="border-bottom: 1px solid #000000">
                <td style="text-align: left"><h5>Штатный, совместитель: </h5></td>
            </tr>
            <tr>
